---
url: https://medium.com/@kevingosse/reading-asynclocal-values-from-a-memory-dump-8be356a46b29
...
slug: reading-asynclocal-values-from-a-memory-dump
description: ""
tags:
- dotnet
- csharp
...
```
> *[Program.cs view raw](https://gist.githubusercontent.com/kevingosse/7422701de799dd9b6142a1c5c1852ad0/raw/2f95cfbdd640f5e0c4ff7d39ae577e79954d5fe7/Program.cs)*
...
```
```
> *[windbg.md view raw](https://gist.githubusercontent.com/kevingosse/bea1eb4e5fcf5011e91ef58a3ac583ec/raw/9ba527757ffa3c509aa6f4521cd762a6d0c91d3e/windbg.md)*
...
```
```
> *[windbg.md view raw](https://gist.githubusercontent.com/kevingosse/c53b11339ead89e1028c9685d508603f/raw/546be235078cabde45749fdc7f4934feab6ae97d/windbg.md)*
...
```
```
> *[windbg.md view raw](https://gist.githubusercontent.com/kevingosse/804a8125bf891d5da6f9baf02a1d264e/raw/fdeaa91fb2c83429dbbe09750af6b04a7794027e/windbg.md)*
...
```
```
> *[windbg.md view raw](https://gist.githubusercontent.com/kevingosse/45c2aa4b152e99e87aff25f79c092078/raw/1d857e5dc4ee6af976faf0fad11cb71fd1f8353c/windbg.md)*
...
Our ClrMD program will open the memory dump, find the `AsyncLocal` array, and extract all the values for every thread. To make things easier, we’re going to use [the DynaMD library](https://kevingosse.medium.com/analyze-your-memory-dumps-in-c-with-dynamd-8e4b110b9d3a).
...
```
> *[Program.cs view raw](https://gist.githubusercontent.com/kevingosse/c37c55a49f305c3dcc51d683f94ee42e/raw/ba05fcf29626b0e7a03ef36d7f561e6d4bd5a54d/Program.cs)*
...
```
> *[Program.cs view raw](https://gist.githubusercontent.com/kevingosse/bbdf4a8ee94be8e15b90f6355eb33625/raw/799f51031f8a3b7e6d037eebfbbaffb36f3a7ebb/Program.cs)*
...
```
> *[Program.cs view raw](https://gist.githubusercontent.com/kevingosse/243db24960e3f970e1fb03ea1886d1cc/raw/b86d6153fd2065c149f164eb229e7ff0b04ee35c/Program.cs)*
...
```
> *[Program.cs view raw](https://gist.githubusercontent.com/kevingosse/d193d844c2cff67ecf6c182a0c6426d3/raw/0fff725d3661421a17c0610bacbaec628c10e361/Program.cs)*
...
```
> *[Program.cs view raw](https://gist.githubusercontent.com/kevingosse/ba1c1094c281c46c3b66b342b8705432/raw/87a09e049ba958c190c81d5df485a7e1a711fa94/Program.cs)*
...
```
> *[Program.cs view raw](https://gist.githubusercontent.com/kevingosse/c2c6ad1a6e8bcd9e5b0f17adb7e1eec1/raw/6c8e9b54adeb9893668072ef9c1b56b1f4f7b7ea/Program.cs)*
