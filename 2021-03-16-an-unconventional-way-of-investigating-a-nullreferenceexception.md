---
url: https://medium.com/@kevingosse/an-unconventional-way-of-investigating-a-nullreferenceexception-5628cca01d6a
...
slug: an-unconventional-way-of-investigating-a-nullreferenceexception
description: ""
tags:
- csharp
- dotnet
...
Eventually, I realized this was leading nowhere, and took the time to setup an ARM64 VM to investigate further. After running the test with LLDB (see [my previous article](https://kevingosse.medium.com/investigating-a-native-deadlock-in-a-net-linux-application-97979a005ebd) to learn how to fetch the symbols for the CLR), I found out that the process was raising two segmentations faults, and the second one caused the crash:
...
```
```
> *[lldb.md view raw](https://gist.githubusercontent.com/kevingosse/5ac484dad56094f8bf51a1570b2b0481/raw/5fe7c83c18df87f1c0b6f0052e098af15344fab7/lldb.md)*
...
```
> *[Program.cs view raw](https://gist.githubusercontent.com/kevingosse/4f51731183b867ab55259f7e19d99100/raw/d0c49516be8efa2245f74de77453eebd53339130/Program.cs)*
...
```
```
> *[lldb.md view raw](https://gist.githubusercontent.com/kevingosse/f089e44444cbe693e08f7cdcf99a02d2/raw/6c0d01374553a9464f449dfca57bf7449f4e83ff/lldb.md)*
...
```
```
> *[lldb.md view raw](https://gist.githubusercontent.com/kevingosse/35b058f8978568cbaecf115eacf532e2/raw/05db3dd7593185a98395506c7f34745f4c7ac566/lldb.md)*
...
```
> *[virtualcallstub.cpp view raw](https://gist.githubusercontent.com/kevingosse/a04316dad9613eb8baa2644880f56a53/raw/6c4c8208bff705f4858becb0549b495bce740691/virtualcallstub.cpp)*
...
holder->Initialize(addrOfCode,
                   ...
                   (size_t)pMTExpected
```
> *[virtualcallstub.cpp view raw](https://gist.githubusercontent.com/kevingosse/c62a5af20c4d7c546f107933e9f6777e/raw/ed5ffcef099e56b445266b5ceff98cfe2a4b4113/virtualcallstub.cpp)*
...
```
> *[virtualcallstubcpu.hpp view raw](https://gist.githubusercontent.com/kevingosse/6302d5e08080250454fd376b2b28ad28/raw/19f5ceadc386aedbf7e10642d31091c32d4f9253/virtualcallstubcpu.hpp)*
...
```
```
> *[lldb.md view raw](https://gist.githubusercontent.com/kevingosse/75d766f6ec6b8ee1b454a08813c1509f/raw/9f59593a8573dffa138a8db4ebee9affcf031ad2/lldb.md)*
...
```
```
> *[lldb.md view raw](https://gist.githubusercontent.com/kevingosse/8578f9de44dfc3d7770e109704a7ab44/raw/208506d47b3d86960584797524c27c307f541ac9/lldb.md)*
...
```
> *[stubs.cpp view raw](https://gist.githubusercontent.com/kevingosse/fdf9a0264305b41452b0c5687a7c8ea9/raw/434b19ac73a972dc30e36762c4b9c817584f9fd4/stubs.cpp)*
...
```
> *[Program.cs view raw](https://gist.githubusercontent.com/kevingosse/be88f3c0c05a122032f7c4ed5341d331/raw/8bdd7b9d43cb6a86db86a8f0567d06dd08e79850/Program.cs)*
...
```
> *[Program.cs view raw](https://gist.githubusercontent.com/kevingosse/b2d4380a4876d5083f0d17f5ca4799b2/raw/1c66de411ce4bb649d3c85a2c53f13bdbe18158a/Program.cs)*
...
```
> *[Program.cs view raw](https://gist.githubusercontent.com/kevingosse/87adfbcd6859bb86e61660671d434892/raw/daf7c7ca8083718c6053d32840a084bdfeaef777/Program.cs)*
...
```
> *[Transport.cs view raw](https://gist.githubusercontent.com/kevingosse/a586f5347fca33396506586b10504bcf/raw/f8583c4856bd2f887f11763523b0d052dd4dfde1/Transport.cs)*
...
```
```
> *[lldb.md view raw](https://gist.githubusercontent.com/kevingosse/34b4147bfb8fda64c0fc7c0f796742d0/raw/36080f8b79828c0698da87f82a06e09b9c115744/lldb.md)*
...
```
        ...
        // ldp x10, x12, [x9] ; x10 = _expectedMT & x12 = _implTarget
```
> *[virtualcallstubcpu.hpp view raw](https://gist.githubusercontent.com/kevingosse/5c2f6e7af0d97b045a66c59cab112f85/raw/0167e2597729e304b0e8913115d6280bf2091d9c/virtualcallstubcpu.hpp)*
...
```
```
> *[lldb.md view raw](https://gist.githubusercontent.com/kevingosse/58f09d7e30f9f9cdb87282d2774b243d/raw/615bc51fa19273734c93776167640c01114f8a35/lldb.md)*
...
```
```
> *[lldb.md view raw](https://gist.githubusercontent.com/kevingosse/f6b46e0b672fe122ddf092a680a42620/raw/7cc33ec8cb1daf06b67fa0ca56a599bcafde7519/lldb.md)*
...
```
> *[Transport.cs view raw](https://gist.githubusercontent.com/kevingosse/d146be97d679f3f7a390042bd6512873/raw/0fbf73f9a53323584c4e8b62840ae6e378026b30/Transport.cs)*
